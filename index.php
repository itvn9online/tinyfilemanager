...
/**
 * Chỉnh lại root path -> luôn cho vào thư mục trước đấy 1 nhịp -> bắt buộc phải có file index.php
 */
...
/**
 * Kiểm tra và đổi lại mật khẩu mặc định tự động
 */
